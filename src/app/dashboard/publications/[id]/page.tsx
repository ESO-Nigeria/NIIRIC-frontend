						...
						<div className="lg:col-span-2 space-y-5 ">
							<div className="px-6 py-3 rounded-8 bg-white">
								<h1 className="text-xl font-bold text-black mb-4">
									Mapping the Impact Investing Landscape in Nigeria – 2025
								</h1>

								<div className="flex items-center gap-4 mb-4">
									<span className="text-base text-gray-500 font-raleway">
										<span className="text-primary-green">Published</span> • May
										2025
									</span>
								...
								<div className="">
									...
									<div className="space-y-4 text-black text-base  font-raleway font-normal leading-relaxed">
										<p className="text-justify">
											As global interest in impact investing continues to rise,
											Nigeria stands at a pivotal point where private capital
											can directly influence inclusive growth. This research
											paper presents a comprehensive mapping of the impact
											investing landscape in Nigeria as of 2025, covering
											institutional actors, funding flows, sectoral focus areas,
											regulatory dynamics, and ecosystem enablers.
										</p>

										<p className="text-justify">
											Through a mixed-methods approach combining desk research,
											interviews with 30+ stakeholders, and comparative analysis
											with peer countries, this report provides a current and
											practical understanding of how impact capital is flowing
											through Nigeria's development space. Key players
											identified include impact funds (such as Alitheia Capital
											and Areki Impact Fund); DFIs (like the African Development
											Bank); corporate foundations; and government-backed
											initiatives. Key trajectories show investment access lines
											including energy, agriculture, health, financial
											inclusion, and education—highlighting where impact
											performance metrics are most developed.
										</p>
