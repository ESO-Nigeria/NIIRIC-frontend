    ...
    <div className="flex mb-6 border p-4 rounded-lg ">
      ...
      <div className="w-3/4 pl-6">
        ...
        <div className="flex space-x-4 mt-2 items-center">
          <span className="px-3 py-1 text-sm text-primary-green bg-primary-brown/20 rounded-full">{category}</span>
          <span className="text-sm text-gray-600"><span className="text-primary-green">By: </span>{byline}</span>
          <span className="text-sm text-primary-green">Sector: {sector}</span>
        </div>
        <p className="text-gray-700 mt-4">
          {description}
          <a href="#" className="text-primary-green font-medium hover:underline"> Read more</a>
        </p>
