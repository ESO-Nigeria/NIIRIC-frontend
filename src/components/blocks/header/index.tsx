...
import { Book, File, Menu, Search, Trees } from "lucide-react";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
    ...
    Dropdown: [
      {
        ...
        icon: <File className="size-5 shrink-0 text-primary-green" strokeWidth={3} />,
        href: "/reports",
      },
      {
        title: "Opportunities",
        description: "Explore Opportunities for Growth, Funding, and Career Advancement",
        icon: <Search className="size-5 shrink-0 text-primary-green" strokeWidth={3} />,
        href: "/opportunities",
      },
        ...
        <nav className="hidden justify-between lg:flex">
          ...
          <div className="items-center flex gap-6">
            ...
            <div className="flex gap-2">
              ...
              <Link href="#" className={buttonVariants({ variant: "primary-green" })}>
                Get Started
              </Link>
            </div>
        </nav>
