							...
							{navItems.map((item) => {
								...
								return (
									<Link
										...
										href={item.href}
										className={cn(
											"flex items-center gap-3 rounded-lg px-3 py-2 text-gray-700 hover:bg-green-50 hover:text-green-700 transition-colors",
											isActive &&
												"text-white bg-primary-green hover:bg-green-700 hover:text-white"
										)}
									>
