...
export const FilterSidebar: React.FC<FilterSidebarProps> = ({
  ...
  return (
    <aside className="rounded-lg border border-[#E3E8EF] bg-white p-6 w-full">
      ...
      <div className="mb-6">
        ...
        <Select value={value.category} onValueChange={handleCategoryChange}>
          ...
          <SelectContent>
            ...
            <SelectItem value="grants">Grants & Funding Opportunities</SelectItem>
      ...
      {(!value.category || value.category === "" || value.category === "all") && (
        <>
          <div className="mb-4">
          ...
          <div className="mb-4">
            <h3 className="text-[#1A3B34] text-base font-medium mb-1">Sectors</h3>
            <div className="flex flex-col gap-2">
          ...
          <div>
            <h3 className="text-[#1A3B34] text-base font-medium mb-1">Deadline</h3>
            <div className="flex flex-col gap-2">
      ...
      {value.category === "grants" && (
        <>
          <div className="mb-4">
            <h3 className="text-[#1A3B34] text-base font-medium mb-1">Funding Type</h3>
            <div className="flex flex-col gap-2">
              {FUNDING_TYPE_OPTIONS.map((opt) => (
                <label key={opt.value} className="flex items-center gap-2 py-0.5 text-[#3F434A] text-sm">
                  <Checkbox
                    checked={value.fundingTypes?.includes(opt.value) || false}
                    onCheckedChange={() => handleCheckboxChange("fundingTypes", opt.value)}
            ...
            <div className="flex flex-col gap-2">
              {SECTOR_OPTIONS.map((opt) => (
                <label key={opt.value} className="flex items-center gap-2 py-0.5 text-[#3F434A] text-sm">
                  <Checkbox
                    checked={value.sectors.includes(opt.value)}
                    onCheckedChange={() => handleCheckboxChange("sectors", opt.value)}
                    id={`sector-${opt.value}`}
                  />
                  {opt.label}
                </label>
          ...
          <div className="mb-4">
            <h3 className="text-[#1A3B34] text-base font-medium mb-1">Target Group</h3>
            <div className="flex flex-col gap-2">
              {TARGET_GROUP_OPTIONS.map((opt) => (
                <label key={opt.value} className="flex items-center gap-2 py-0.5 text-[#3F434A] text-sm">
                  <Checkbox
                    checked={value.targetGroups?.includes(opt.value) || false}
                    onCheckedChange={() => handleCheckboxChange("targetGroups", opt.value)}
            ...
            <div className="flex flex-col gap-2">
              {DEADLINE_OPTIONS.map((opt) => (
                <label key={opt.value} className="flex items-center gap-2 py-0.5 text-[#3F434A] text-sm">
                  <Checkbox
                    checked={value.deadlines.includes(opt.value)}
                    onCheckedChange={() => handleCheckboxChange("deadlines", opt.value)}
                    id={`deadline-${opt.value}`}
                  />
                  {opt.label}
                </label>
      ...
      {value.category === "training" && (
        <>
          <div className="mb-4">
            <h3 className="text-[#1A3B34] text-base font-medium mb-1">Program Type</h3>
            <div className="flex flex-col gap-2">
              {PROGRAM_TYPE_OPTIONS.map((opt) => (
                <label key={opt.value} className="flex items-center gap-2 py-0.5 text-[#3F434A] text-sm">
                  <Checkbox
                    checked={value.programTypes?.includes(opt.value) || false}
                    onCheckedChange={() => handleCheckboxChange("programTypes", opt.value)}
          ...
          <div className="mb-4">
            <h3 className="text-[#1A3B34] text-base font-medium mb-1">Format</h3>
            <div className="flex flex-col gap-2">
              {FORMAT_OPTIONS.map((opt) => (
                <label key={opt.value} className="flex items-center gap-2 py-0.5 text-[#3F434A] text-sm">
                  <Checkbox
                    checked={value.formats?.includes(opt.value) || false}
                    onCheckedChange={() => handleCheckboxChange("formats", opt.value)}
                    id={`format-${opt.value}`}
                  />
                  {opt.label}
                </label>
          ...
          <div className="mb-4">
            <h3 className="text-[#1A3B34] text-base font-medium mb-1">Eligibility</h3>
            <div className="flex flex-col gap-2">
              {ELIGIBILITY_OPTIONS.map((opt) => (
                <label key={opt.value} className="flex items-center gap-2 py-0.5 text-[#3F434A] text-sm">
                  <Checkbox
                    checked={value.eligibilities?.includes(opt.value) || false}
                    onCheckedChange={() => handleCheckboxChange("eligibilities", opt.value)}
      ...
      {value.category === "jobs" && (
        <>
          <div className="mb-4">
            <h3 className="text-[#1A3B34] text-base font-medium mb-1">Job Type</h3>
            <div className="flex flex-col gap-2">
              {JOB_TYPE_OPTIONS.map((opt) => (
                <label key={opt.value} className="flex items-center py-0.5 gap-2 text-[#3F434A] text-sm">
                  <Checkbox
                    checked={value.jobTypes?.includes(opt.value) || false}
                    onCheckedChange={() => handleCheckboxChange("jobTypes", opt.value)}
              ...
              {LEVEL_OPTIONS.map((opt) => (
                <label key={opt.value} className="flex items-center py-0.5 gap-2 text-[#3F434A] text-sm">
                  <Checkbox
                    ...
                    onCheckedChange={() => handleCheckboxChange("levels", opt.value)}
                    id={`level-${opt.value}`}
                  />
                  {opt.label}
                </label>
          ...
          <div className="mb-4">
            <h3 className="text-[#1A3B34] text-base font-medium mb-1">Location</h3>
            <div className="flex flex-col gap-2">
              {LOCATION_OPTIONS.map((opt) => (
                <label key={opt.value} className="flex items-center py-0.5 gap-2 text-[#3F434A] text-sm">
                  <Checkbox
                    checked={value.locations?.includes(opt.value) || false}
                    onCheckedChange={() => handleCheckboxChange("locations", opt.value)}
