...
import { User, GraduationCap, Heart, Building, ContactRound, BookUp } from "lucide-react";
...
import { Qualification, ResearchArea, ResearchInterest, User as UserProps } from "../types/profile";
            ...
            {personal_info_loading ? (
              ...
              <Card className="border-primary-green shadow-none bg-green-50">
                <CardContent className="flex flex-col gap-3">
                  ...
                  <p className="text-sm text-[#3F434A]">Update your personal information.</p>
                  <Link href="/dashboard/profile-journey/profile-completion" className={clsx(buttonVariants({variant: "primary-green"}), "w-36")}>
                    Update
                  </Link>
                </CardContent>
              </Card>
            ...
            {qualifications_loading ? (
              ...
              <Card className="border shadow-none">
                <CardContent className="flex flex-col gap-3">
                  ...
                  <p className="text-sm text-[#3F434A]">Add your educational background and degrees.</p>
                  <Link href="/dashboard/profile-journey/qualification" className={clsx(buttonVariants({variant: "primary-green"}), "w-36")}>
                    Add Qualification
                  </Link>
                </CardContent>
              </Card>
            ...
            {interest_loading ? (
              ...
              <Card className="border shadow-none">
                <CardContent className="flex flex-col gap-3">
                  ...
                  <p className="text-sm text-[#3F434A]">Define your areas of interest and expertise.</p>
                  <Link href="/dashboard/profile-journey/research-interests" className={clsx(buttonVariants({variant: "primary-green"}), "w-36")}>
                    Add Interests
                  </Link>
                </CardContent>
              </Card>
            ...
            {research_area_loading ? (
              ...
              <Card className="border shadow-none">
                <CardContent className="flex flex-col gap-3">
                  ...
                  <Link href="/dashboard/profile-journey/research-area" className={clsx(buttonVariants({variant: "primary-green", size: "sm"}), "w-36")}>
                    Add Research Area
                  </Link>
                </CardContent>
              </Card>
